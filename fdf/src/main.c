...
/*   Updated: 2024/10/14 05:18:31 by tbrunier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	terminate_program(t_data *data)
{
	...
	free(data->img);//free structure image
	ft_free_matrix(data->fdf->matrix, data->fdf->map_y);//free la matrice
	free(data->fdf);//free fdf
